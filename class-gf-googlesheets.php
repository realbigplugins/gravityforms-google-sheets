...
class GFGoogleSheets extends GFFeedAddOn {
	 ...
	 * @since 1.0.0
	 *
	 * @param array $args Optional args to send to the listFiles() query.
	 */
	public function get_sheet_choices( $args = array() ) {
		...
		try {
			...
			$response = $this->api_drive->files->listFiles( wp_parse_args( array(
				'q' => "mimeType='application/vnd.google-apps.spreadsheet'" .
				       ( isset( $search ) ? " and name contains '$search'" : '' ),
			), $args ) );
